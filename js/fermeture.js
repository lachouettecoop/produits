const CLOSED_TIMESTAMP = 1586606400929;
...
function displayClosedOverlay() {
  ...
  document.body.innerHTML = `
    <div class="bg-green-900 h-screen v-screen text-white text-center flex flex-col items-center justify-center">
      ...
      <p class="text-4xl font-bold mt-6 mb-4">
        Le Drive est exceptionnellement fermé ce jour (mercredi 15)
      </p>

      <p class="text-xl">
        En raison d'un problème informatique, nous ne sommes pas en mesure
        d'ouvrir le Drive cet après-midi.
        <br>
        Nous espérons être en mesure d'avoir résolu ce problème pour ouvrir
        dans les conditions habituelles <strong>dès demain (jeudi 16)</strong>.
      </p>
